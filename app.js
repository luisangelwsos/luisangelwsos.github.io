...
const qa = [
  ...
  },
  {
    ...
    es: 'Luis Angel ha construido 8 sistemas con Claude Code:\n\n🌲 C&C Liébana — CRM con 6 agentes IA para su empresa forestal (cofundador, en producción)\n🤖 Bot de Trading "Murph" v5.0 — 25+ agentes IA, ML con AUC=0.756\n🔭 THEAGENT — buscador de oportunidades de inversión (Grok en tiempo real + 13F de la SEC + predicción falsable)\n📦 Amazon FBA España — 9 agentes IA (Fase 1 completa)\n🛡️ CRM con IA para Agente de Seguros — 6 agentes, mentor de ventas con RAG\n🧾 Agente Facturas — app contable para hostelería (FastAPI + Telegram)\n🍽️ Casa Ángel — Lo del Pibe — sistema completo para restaurante\n🏢 Agencia de Marketing — app full-stack con Next.js\n\nPregúntame por cualquiera de ellos para más detalles.',
    en: 'Luis Angel has built 8 systems with Claude Code:\n\n🌲 C&C Liébana — CRM with 6 AI agents for his forestry company (co-founder, in production)\n🤖 Trading Bot "Murph" v5.0 — 25+ AI agents, ML with AUC=0.756\n🔭 THEAGENT — investment opportunity finder (real-time Grok + SEC 13F + falsifiable prediction)\n📦 Amazon FBA Spain — 9 AI agents (Phase 1 complete)\n🛡️ AI CRM for an Insurance Agent — 6 agents, sales mentor with RAG\n🧾 Invoice Agent — accounting app for hospitality (FastAPI + Telegram)\n🍽️ Casa Ángel — Lo del Pibe — full restaurant system\n🏢 Marketing Agency — full-stack Next.js app\n\nAsk me about any of them for more details.'
  },
  {
    keys: ['theagent', 'the agent', 'inversion', 'inversión', 'invertir', 'invest', 'grok', 'ballenas', '13f', 'arturo', 'acciones', 'stocks', 'bolsa'],
    es: '🔭 THEAGENT es el agente insignia de Luis Angel: un buscador de oportunidades de inversión.\n\nCruza información en tiempo real de Grok (X) con patrones de conducta de mercado y datos de yfinance para emitir veredictos con predicción falsable: cada tesis se guarda en un ledger que mide el acierto real.\n\nIncluye "Arturo" (análisis fundamental, macro y técnico) y "Ballenas" (lectura de los formularios 13F de la SEC de inversores legendarios: sus carteras y movimientos).',
    en: '🔭 THEAGENT is Luis Angel\'s flagship agent: an investment opportunity finder.\n\nIt cross-references real-time Grok (X) data with market behavior patterns and yfinance data to issue verdicts with a falsifiable prediction: every thesis is stored in a ledger that measures real hit-rate.\n\nIt includes "Arturo" (fundamental, macro and technical analysis) and "Ballenas" (reading SEC 13F filings from legendary investors: their holdings and moves).'
  },
  {
    keys: ['factura', 'facturas', 'invoice', 'contab', 'accounting', 'hosteleria', 'hostelería', '347', '303', 'fiscal', 'impuestos', 'taxes'],
    es: '🧾 Agente Facturas es una app contable a medida para restaurantes.\n\nRegistra ventas y facturas y prepara de forma automática los modelos fiscales (347, 303). Está construida sobre FastAPI + SQLite con Claude para leer los documentos, e incluye un bot de Telegram independiente para subir facturas desde el móvil.\n\nActualmente en piloto en un restaurante real.',
    en: '🧾 Invoice Agent is a custom accounting app for restaurants.\n\nIt tracks sales and invoices and automatically prepares tax forms (347, 303). Built on FastAPI + SQLite with Claude to read the documents, it also includes a standalone Telegram bot to upload invoices from the phone.\n\nCurrently piloting in a real restaurant.'
  },
  {
